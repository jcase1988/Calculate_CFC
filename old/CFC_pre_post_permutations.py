#@profile
def CFC_pre_post_permutations(subj,blocks,phase_elec,amp_elec,surrogate_analysis):
    ...
    MI_output_path = '/Users/johncase/Documents/UCSF Data/' + subj + '/' + subj + ''.join(blocks) + '/analysis/MI/e' + str(phase_elec) + '_e' + str(amp_elec)
    ...
    fa = [(i,i+4) for i in arange(50,200,4)]
...
CFC_pre_post_permutations('EC71',['B2','B11'],2,90,1)